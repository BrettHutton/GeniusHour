...
package net.mcreator.sixheadeddragon.block;
...
public class SpeedblockBlock extends SixHeadedDragonElements.ModElement {
	@ObjectHolder("sixheadeddragon:speedblock")
	public static final Block block = null;
	public SpeedblockBlock(SixHeadedDragonElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("it can make you run fast"));
		}
